...
public class ReadOnlyByteOldBufferTest extends AbstractOldBufferTest {
     ...
     * something else. Need to do a major overhaul of the OldBuffer stuff so that when you do slice
    ...
    private void ensureNoWriteSupport(final OldBuffer buffer, final ThrowingConsumer<OldBuffer> writeOp) throws Exception {
        try {
