 ...
 */
public class InputStreamOldBufferTest extends AbstractOldBufferTest {
     ...
     */
    private void assertContent(final OldBuffer buffer, final byte[] actual, final int offset) throws Exception {
