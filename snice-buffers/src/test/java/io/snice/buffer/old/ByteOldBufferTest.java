 ...
 * 
 */
public class ByteOldBufferTest extends AbstractOldBufferTest {
    ...
    public void testWriteIntAsString() throws Exception {
        final OldBuffer buffer = Buffers.createBuffer(100);
    ...
    public void testWrapArraySpecifyingTheWindows() throws Exception {
        final OldBuffer buffer = Buffers.wrap("hello world".getBytes(), 3, 9);
    ...
    IOException {
        final OldBuffer buffer = createBuffer(number);
    ...
    public void testClone() throws Exception {
        final OldBuffer buffer = Buffers.wrap(allocateByteArray(100));
        final OldBuffer clone = buffer.clone();
        ...
        // correct
        final OldBuffer slice = clone.slice(30, 40);
        assertThat(slice.getByte(0), is((byte) 30));
        final OldBuffer sliceClone = slice.clone();
        assertBuffers(sliceClone, slice);
    }

    @Test
    public void testMap() throws Exception {
        final OldBuffer a = createBuffer("hello");
        final Map<OldBuffer, String> map = new HashMap<OldBuffer, String>();
        map.put(a, "fup");
        assertThat(map.get(a), is("fup"));

        final OldBuffer b = createBuffer("hello");
        assertThat(map.get(b), is("fup"));

        final OldBuffer c = createBuffer("world");
        map.put(c, "apa");
        assertThat(map.containsKey(c), is(true));

        final OldBuffer d = createBuffer("nope");
    ...
    private void assertBufferEqualityIgnoreCase(final String a, final String b, final boolean equals) {
        final OldBuffer bufA = createBuffer(a);
        final OldBuffer bufB = createBuffer(b);
    ...
    public void testEqualsHashCode() throws Exception {
        final OldBuffer b1 = createBuffer("hello world");
        final OldBuffer b2 = createBuffer("hello world");
        assertThat(b1, is(b2));
        assertThat(b1.hashCode(), is(b2.hashCode()));

        final OldBuffer b3 = createBuffer("hello not world");
        ...
        final OldBuffer a1 = createBuffer("123 world");
        final OldBuffer a2 = createBuffer("456 world");
        assertThat(a1, not(a2));
        assertThat(a1.hashCode(), not(a2.hashCode()));

        final OldBuffer a1_1 = a1.readBytes(3);
        final OldBuffer a2_1 = a2.readBytes(3);
        assertThat(a1_1, not(a2_1));
        assertThat(a1_1.hashCode(), not(a2_1.hashCode()));

        // now they should be equal
        final OldBuffer a1_2 = a1.slice();
        final OldBuffer a2_2 = a2.slice();
        assertThat(a1_2, is(a2_2));
        assertThat(a1_2.hashCode(), is(a2_2.hashCode()));

        final OldBuffer a1_3 = a1.readBytes(5);
        final OldBuffer a2_3 = a2.readBytes(5);
        assertThat(a1_3, is(a2_3));
        assertThat(a1_3.hashCode(), is(a2_3.hashCode()));

        final OldBuffer from = createBuffer("From");
        final OldBuffer fromHeader = createBuffer("some arbitrary crap first then From and then some more shit");
        fromHeader.readBytes(31);
        final OldBuffer fromAgain = fromHeader.readBytes(4);
    ...
    public void testReadUntilFromSlicedBuffer() throws Exception {
        final OldBuffer original = createBuffer("hello world this is going to be a longer one".getBytes());
        final OldBuffer buffer = original.slice(6, original.capacity());
        final OldBuffer world = buffer.readUntil((byte) ' ');
        assertThat(world.toString(), is("world"));

        final OldBuffer longer = buffer.readUntil((byte) 'a');
        assertThat(longer.toString(), is("this is going to be "));

        final OldBuffer theRest = buffer.readLine();
        assertThat(theRest.toString(), is(" longer one"));
    }

    private void assertBuffers(final OldBuffer b1, final OldBuffer b2) throws Exception {
    ...
    public void testSliceEmptyBuffer() throws Exception {
        OldBuffer buffer = Buffers.EMPTY_BUFFER;
     ...
     * @param buffer
     */
    private void assertEmptyBuffer(final OldBuffer buffer) {
    ...
    public void testSliceChangesAffectEachOther() throws Exception {
        final OldBuffer buffer = Buffers.wrap(allocateByteArray(100));
        final OldBuffer b1 = buffer.slice(10, 20);
    ...
    public void testGetBytesDestinationBigger() throws Exception {
        final OldBuffer buffer = Buffers.wrap("hello world");
        OldBuffer b = Buffers.createBuffer(100);
        buffer.getBytes(b);
    ...
    public void testDoubleSlice() throws Exception {
        ...
        final OldBuffer buffer = createBuffer(str);
        buffer.readByte();
        final OldBuffer b1 = buffer.slice();
        assertThat(b1.toString(), is(str.substring(1)));

        final OldBuffer b2 = b1.readBytes(20);
        ...
        final OldBuffer b2Slice = b2.slice();
        assertThat(b2Slice.toString(), is(str.subSequence(1, 21)));

        final OldBuffer again = b2Slice.slice(4, 10);
    ...
    public void testGetBytesAfterBunchOfWrites() throws Exception {
        ...
        final OldBuffer copy = Buffers.createBuffer(100);
    ...
    public void testGetBytes() throws Exception {
        final OldBuffer buffer = Buffers.wrap("hello world");
        OldBuffer b = Buffers.createBuffer(5);
    ...
    public void testGetBytesAfterSlice() throws Exception {
        ...
        buffer.readBytes(5);
        buffer.readByte();
        final OldBuffer world = buffer.slice();
        assertThat(world.toString(), is("world"));
        final OldBuffer copy = Buffers.createBuffer(50);
    ...
    public void testWrite() throws Exception {
        ...
        final OldBuffer b = buffer.slice();
    ...
    public void testWriteJustEnough() throws Exception {
        final OldBuffer buffer = Buffers.createBuffer("hello world".length() * 2 + 1);
    ...
    public void testWriteTooMuch() throws Exception {
        ...
        final OldBuffer buffer = Buffers.createBuffer(capacity);
        try {
    ...
    public void testWriteToSmall() throws Exception {
        final OldBuffer buffer = Buffers.createBuffer(1);
    ...
    @Override
    public OldBuffer createBuffer(final byte[] array) {
