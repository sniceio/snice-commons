...
import io.snice.buffer.RawData;
 ...
 */
public abstract class AbstractOldBufferTest {
     ...
     * @return
     */
    public abstract OldBuffer createBuffer(byte[] array);
    ...
    public void testReadUntilSingleCRLF() throws Exception {
        ...
        OldBuffer buffer = createBuffer("hello");
        assertThat(buffer.readUntilSingleCRLF(), is((OldBuffer)null));
    ...
    public void testReadUntilDoubleCRLF() throws Exception {
        OldBuffer buffer = createBuffer("hello\r\n\r\nworld");
        OldBuffer hello = buffer.readUntilDoubleCRLF();
        ...
        buffer = createBuffer("\r\n\r\n");
        final OldBuffer empty = buffer.readUntilDoubleCRLF();
        ...
        assertThat(hello.toString(), is("hello"));
        assertThat(buffer.toString(), is("world\r\n\r\nworld"));
        final OldBuffer world = buffer.readUntilDoubleCRLF();
    ...
    public void testIndexOf() throws Exception {
        final OldBuffer buffer = createBuffer("hello world ena goa grejor".getBytes());
    ...
    public void testReadUntil2() throws Exception {
        OldBuffer buffer = createBuffer("this is a somewhat long string".getBytes());
        OldBuffer buf = buffer.readUntil(100, (byte) 'a', (byte) 'o');
        ...
        final OldBuffer slice = buffer.slice(buffer.getReaderIndex() + 5);
    ...
    public void testReadUntil() throws Exception {
        OldBuffer buffer = createBuffer("hello world".getBytes());
        final OldBuffer hello = buffer.readUntil((byte) ' ');
        assertThat(hello.toString(), is("hello"));

        // read the next 5 bytes and that should give us the world part
        final OldBuffer world = buffer.readBytes(5);
        assertThat(world.toString(), is("world"));
        ...
        final OldBuffer empty = buffer.readUntil((byte) 'h');
        assertThat(empty.toString(), is(""));

        // then read until 'a' is found
        final OldBuffer more = buffer.readUntil((byte) 'a');
        assertThat(more.toString(), is("ello world "));

        final OldBuffer gai = buffer.readUntil((byte) 'n');
    ...
    public void testRead() throws Exception {
        final OldBuffer buffer = createBuffer(RawData.rawEthernetFrame);

        // read 100 bytes at a time
        for (int i = 0; i < 5; ++i) {
            final OldBuffer hundred = buffer.readBytes(100);
        ...
        // left
        final OldBuffer theRest = buffer.readBytes(47);
    ...
    public void testReadLineSingleLineNoCRLF() throws Exception {
        ...
        final OldBuffer buffer = createBuffer(s.getBytes());
        assertThat(buffer.readLine().getArray(), is(s.getBytes()));

        // no more lines to read
        assertThat(buffer.readLine(), is((OldBuffer) null));
    }
    ...
    public void testReadLine() throws Exception {
        int count = 0;
        final OldBuffer buffer = createBuffer(RawData.sipBuffer.getArray());
    ...
    public void testReadLines() throws Exception {
        ...
        OldBuffer buffer = createBuffer((line1 + "\n" + line2).getBytes());
    ...
    public void testReadBytes() throws IOException {
        final OldBuffer buffer = createBuffer(allocateByteArray(100));
        final OldBuffer b1 = buffer.readBytes(10);
    ...
    public void testSlice() throws Exception {
        final OldBuffer buffer = createBuffer(allocateByteArray(100));
        final OldBuffer b1 = buffer.slice(50, 70);
        ...
        final OldBuffer b2 = b1.slice(b1.capacity());
        ...
        final OldBuffer b3 = b2.slice(0, 18);
    ...
    public void testResetAndMarkReaderIndex() throws Exception {
        ...
        final OldBuffer slice = buffer.slice(30, 50);
    ...
    public OldBuffer createBuffer(final String s) {
