...
public class EmptyBuffer implements ReadOnlyBuffer {
     ...
     */
    @Override
    public OldBuffer readLine() throws IOException {
        throw new IndexOutOfBoundsException(NOT_ENOUGH_READABLE_BYTES);
    }

    @Override
    public OldBuffer readUntilSingleCRLF() throws IOException {
        throw new IndexOutOfBoundsException("Not enough readable bytes");
    }

    @Override
    public OldBuffer readUntilDoubleCRLF() throws IOException {
        throw new IndexOutOfBoundsException(NOT_ENOUGH_READABLE_BYTES);
    }
     ...
     */
    @Override
    public OldBuffer readUntil(final byte b) throws IOException, ByteNotFoundException {
     ...
     */
    @Override
    public OldBuffer slice(final int stop) {
        if (stop != 0) {
            throw new IndexOutOfBoundsException(THIS_BUFFER_IS_EMPTY);
        }
        return this;
    ...
    @Override
    public OldBuffer readUntil(final int maxBytes, final byte... bytes) throws IOException, ByteNotFoundException {
        if (bytes.length == 0) {
            return this;
        }
    ...
    @Override
    public OldBuffer readUntilSafe(final int maxBytes, final byte... bytes) throws IOException, IllegalArgumentException {
        if (bytes.length == 0) {
            return this;
        }
        throw new ByteNotFoundException(bytes[0]);
    ...
    public boolean equalsIgnoreCase(final Object other) {
        ...
        try {
            return ((OldBuffer) other).isEmpty();
