 ...
 */
public interface OldBuffer extends Cloneable {
    ...
    /**
     * Same as calling {@link #getBytes(int, OldBuffer)} where the index is
     * {@link #getReaderIndex()}.
     * 
     * @param dst
     * @throws IndexOutOfBoundsException
     */
    void getBytes(OldBuffer dst);
     ...
     *             in case index < 0
     */
    void getBytes(final int index, final OldBuffer dst) throws IndexOutOfBoundsException;
     ...
     * @throws IOException
     */
    OldBuffer readBytes(int length) throws IndexOutOfBoundsException, IOException;
     ...
     *         characters
     */
    OldBuffer readLine() throws IOException;
     ...
     * in.
     *
     * Note that this one is very similar to {@link OldBuffer#readLine()} but the
     ...
     *         found.
     */
    OldBuffer readUntilSingleCRLF() throws IOException;
     ...
     *         found.
     */
    OldBuffer readUntilDoubleCRLF() throws IOException;
     ...
     * available depending on the underlying implementation. E.g., a OldBuffer
     ...
     * that is left in the {@link OldBuffer} will not contain that byte.
     * 
     * Example: <code>
     *    OldBuffer buffer = Buffers.wrap("hello world");
     *    OldBuffer hello = buffer.readUntil((byte)' ');
     ...
     */
    OldBuffer readUntil(byte b) throws IOException, ByteNotFoundException;
     ...
     */
    OldBuffer readUntil(int maxBytes, byte... bytes) throws IOException, ByteNotFoundException, IllegalArgumentException;
     ...
     * @throws IllegalArgumentException
     */
    OldBuffer readUntilSafe(int maxBytes, byte... bytes) throws IOException, IllegalArgumentException;
     ...
     * instead.
     * 
     * NOTE. The index is representing where in the {@link OldBuffer} you can find
     * the byte and the index is in relation to the entire {@link OldBuffer} and
     ...
     * @return
     */
    OldBuffer slice(int start, int stop);

    /**
     * Same as {@link #slice(OldBuffer.getReaderIndex(), int)}
     * 
     * @param stop
     * @return
     */
    OldBuffer slice(int stop);

    /**
     * Slice off the rest of the buffer. Same as {@link
     * #slice(OldBuffer.getReaderIndex(), buffer.getCapacity())}
     * 
    ...
    /**
     * If you access the {@link OldBuffer#getRawArray()} you will get just that. The raw
    ...
    /**
     * See explanation in {@link OldBuffer#getLowerBoundary()} since this is the same, just
    ...
    /**
     * Checks whether this {@link OldBuffer} has any space left for writing. Same
    ...
    /**
     * Check whether this {@link OldBuffer} has write support or not. There are
    ...
    /**
     * Same as {@link OldBuffer#write(String, String)} where the charset is set to
     * "UTF-8"
     * 
     * @param s
     * @throws IndexOutOfBoundsException
     *             in case we cannot write entire String to this {@link OldBuffer}.
     * @throws WriteNotSupportedException
     *             in case the underlying implementation does not support
     *             writes.
    ...
    /**
     * Write the integer value to this {@link OldBuffer} as a String.
     * 
     * @param value
     *            the value that will be converted to a String before being
     *            written to this {@link OldBuffer}.
     * @throws IndexOutOfBoundsException
     * @throws WriteNotSupportedException
     */
    ...
    /**
     * Write the long value to this {@link OldBuffer} as a String.
     * 
