...
public final class DefaultWritableBuffer implements WritableBuffer {
    ...
    private DefaultWritableBuffer(final int capacity) {
    ...
    private DefaultWritableBuffer(final byte[] buffer) {
        this.buffer = buffer;
        this.wrap = Buffer.of(buffer).toReadableBuffer();
    ...
    public boolean equalsIgnoreCase(final Object b) {
        ...
        if (b instanceof DefaultWritableBuffer) {
            final DefaultWritableBuffer other = (DefaultWritableBuffer) b;
    ...
    public boolean equals(final Object o) {
        ...
        try {
            ...
            if (o instanceof WritableBuffer) {
                final Buffer that = ((DefaultWritableBuffer)o).sliceToSize();
